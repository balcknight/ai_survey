...
**峰检测**：
优化:增加宽度检测，如果宽度小于5，忽略
异常数据:
/data/work/zhurui/survey_rec/data/shenshaoqi_data/survey1/X101SC2501/X101SC25015691-Z01-J020/FDES250046014-1r_CNS02440-1
/data/work/zhurui/survey_rec/data/shenshaoqi_data/survey1/X101SC2502/X101SC25021371-Z03-J003/FDSW250026064-1r_N-1-尾肌-备份7
...
5. 返回峰的 depth 列表、frequency 列表、异常标记列表，按升序排列
...
### 判定脚本
nohup /data/home/zhurui/.conda/envs/zhurui_agent/bin/python survey_judge.py --max 100 > survey_judge.log 2>&1 &
...
### v3优化
1. kmer 1:4，再次检测，极大的降低峰标准，看中间有没有峰，有，看是不是1:2:4 多倍体，否则异常
2. 重度污染:NT正常10分，但是kmer异常，属于是重中之重，别流转
3. NT大类，top1为本物种给2分，小类判断给3分，在重度污染重，kmer正常的情况下，如果小于等于2分，不流转



### 有空看看
/data/work/zhurui/survey_rec/data/shenshaoqi_data/survey1/X101SC2508/X101SC25084601-Z02-J001/FDES250025403-1r_YY.1
/data/work/zhurui/survey_rec/data/shenshaoqi_data/survey1/X101SC2510/X101SC25105856-Z01-J004/FDSW250047713-1r_JBBY/JBBY.17merFreq
